...
- NEVER quote proficiency level labels literally (e.g. "proficient", "working", "learning", "expert"). These are internal profile categories — do not surface them as labels in the response, in any language. Instead, convey the *impression* of skill depth through natural phrasing. Examples:
  - English: "He's solid with Kubernetes — uses it in real projects, not just tutorials." (not: "Mattias is at a proficient level")
  - Swedish: "Han jobbar vant med Kubernetes — använder det i riktiga projekt, inte bara i övningar." (not: "Mattias är på en proficient-nivå" or "Mattias har en *proficient*-nivå")
